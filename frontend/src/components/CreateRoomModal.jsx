            ...
            <div className="space-y-5">
              ...
              {formData.isPrivate && (
                <div className="animate-slideDown">
                  ...
                  <input 
                    type="password" required={formData.isPrivate} placeholder="Güçlü bir şifre girin"
                    value={formData.roomPassword} onChange={(e) => setFormData({...formData, roomPassword: e.target.value})}
                    className="w-full bg-orange-500/5 border border-orange-500/30 rounded-2xl px-5 py-4 text-sm focus:border-orange-500 outline-none transition-all placeholder:text-orange-900/30"
                  />
                </div>
              )}
